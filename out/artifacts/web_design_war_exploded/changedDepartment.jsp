...
<script>
    ...
    $(function () {
        ...
        $table.bootstrapTable({
            ...
            columns: [
                ...
                {field: 'did1', title: '前部门编号', sortable: true, halign: 'center'},
                {field: 'did2', title: '现部门编号', sortable: true, halign: 'center'},
    ...
    function Search() {
        ...
        $('#table').bootstrapTable('refresh',
            {
                url: 'getDepartmentTransfer?starttime=' + starttime + '&' +
                    'endtime=' + endtime + '&' +
                    'sid=' + sid + '&' +
                    'sname=' + sname + '&' +
                    'type=' + type
