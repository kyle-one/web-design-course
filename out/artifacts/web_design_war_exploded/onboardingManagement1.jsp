...
<div style="padding: 30px 20%;">
    ...
    <hr>
    <form action="${pageContext.request.contextPath }/AddStaffServlet" method="post" onsubmit="return checkEmpty1()">
        ...
        <div class="form-group">
            ...
            <input id="idcardNo" name="idcardNo" type="text" class="form-control">
        </div>
        <div>
        ...
        <div class="form-group">
            ...
            <input id="nativePlace" name="nativePlace" type="text" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="Hukou">户口所在地</label>
            <input id="Hukou" name="Hukou" type="text" class="form-control">
        </div>
        <div>
        ...
        <div class="form-group">
            <label for="majors">所学专业</label>
            <input id="majors" name="majors" type="text" class="form-control">
        </div>
        <div class="form-group">
    ...
    <select name="did" id="did" class="form-control">
        ...
        <div>
            ...
            <div class="form-group">
                ...
                <input id="workDate" name="workDate" type="date" class="form-control">
            </div>
...
<%--            <a class="btn btn-primary" href="javascript:;" onclick="createAction()" style="font-size: 15px;">员工入职</a>--%>
            <input type="submit" name="" value="提交" class="btn btn-primary" style="font-size: 15px;"/>
            <input type="reset" name="" value="重置" class="btn btn-primary" style="font-size: 15px;"/>
        </div>
    </form>
</div>
<script>
