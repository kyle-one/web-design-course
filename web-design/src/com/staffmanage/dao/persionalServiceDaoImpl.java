...
public class persionalServiceDaoImpl implements persionalServiceDao {
    ...
    public List<persionalReport> getStudentBySid(String beginTime) {
        ...
        try {
            ...
            rs.close();
            persionalReport  psn=new persionalReport();
            psn.setDepartment("总计");
            int n=nums.size();
            for(int i=0;i<n;i++){
                psn.setMonthBeginNum(psn.getMonthBeginNum()+nums.get(i).getMonthBeginNum());
                psn.setMonthEndnum(psn.getMonthEndnum()+nums.get(i).getMonthEndnum());
                psn.setThisMonthIn(psn.getThisMonthIn()+nums.get(i).getThisMonthIn());
                psn.setThisMonthOut(psn.getThisMonthOut()+nums.get(i).getThisMonthOut());
                psn.setGetThisMonthChangeIn(psn.getGetThisMonthChangeIn()+nums.get(i).getGetThisMonthChangeIn());
                psn.setGetThisMonthChangeOut(psn.getGetThisMonthChangeOut()+nums.get(i).getGetThisMonthChangeOut());
                psn.setGraduteStudent(psn.getGraduteStudent()+nums.get(i).getGraduteStudent());
                psn.setUngraduteStudent(psn.getUngraduteStudent()+nums.get(i).getUngraduteStudent());
                psn.setJuniorStudent(psn.getJuniorStudent()+nums.get(i).getJuniorStudent());
                psn.setSeninoHighStudent(psn.getSeninoHighStudent()+nums.get(i).getSeninoHighStudent());
            }
            nums.add(psn);
