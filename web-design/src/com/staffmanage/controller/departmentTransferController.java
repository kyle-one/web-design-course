...
@WebServlet("/getDepartmentTransfer")
public class departmentTransferController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<DepartmentTransferView> dtlist;

        departmentTransferDao dtd = new departmentTransferDaoImp();

        dtlist = dtd.getByTimeAndSidAndSnameAndType(starttime,endtime,sid,sname,type);
...
//
        ...
        resp.getWriter().write(gson.toJson(dtlist));
    }
