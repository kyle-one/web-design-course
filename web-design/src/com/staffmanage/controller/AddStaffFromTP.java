...
@WebServlet("/AddStaffFromTP")
public class AddStaffFromTP extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddStaffFromTP() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //3.找到某个视图响应回去
        request.getRequestDispatcher("onboardingManagement3.jsp").forward(request, response);
    }
