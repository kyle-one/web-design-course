...
@WebServlet("/GetStaffByINPDServlet")
public class GetStaffByINPDServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetStaffByINPDServlet() {
        super();
...
//        staffDao1 sd=new staffDaoImpl();
        ...
        stas=ss.getStaffByINPD(did,dname,id,name);
