...
<div id="changeDataDialog" class="crudDialog" style="padding: 30px 20%;">
    <form action="${pageContext.request.contextPath }/updateChange" method="post" id="justform">
        <%
            //List<Post> postList;
        ...
        <div class="form-group">
            ...
            <a style="font-size: 16px;">原部门：</a><br>
            <input type="text" class="form-control" value="<%=did1%>" name="did1" >
            <a style="font-size: 16px;">调入部门：</a><br>
            <select class="form-control2" name="did2">
                <%for (int i = 0; i < departmentList.size(); i++) {%>
                <option id="<%=departmentList.get(i).getDname()%>" value="<%=departmentList.get(i).getDnum()%>"><%=departmentList.get(i).getDname()%>
                </option>
                <%}%>
            </select><br>
...
<script>
    function updateAction() {
        ...
        // }
            ...
            document.getElementById("justform").submit();
