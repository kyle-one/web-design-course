...
<div style="padding: 30px 20%;">
    ...
    <%
        ...
        if(establishDate=="undefined"){establishDate=" ";}
    ...
    <div id="createDialog" class="crudDialog">
        <form id="newForm" action="${pageContext.request.contextPath }/DepartmentUpdate" method="post">
            <%--    <form >--%>
            ...
            <div class="form-group" hidden>
                <label for="dnum" class="active">名称（必填）</label>
