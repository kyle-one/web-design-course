...
<html lang="zh-cn">
	...
	<body>
		<div id="main">
			<form method="get" class="form-inline " style="padding: 3% 5% 3% 5%;" role="form" action="getAllpersionalNumsServlet">
				<div class="input-group">
					<span class="input-group-addon">开始时间</span>
					<input type="month" class="form-control"  name ="beginTime" id ="beginTime" placeholder="twitterhandle">
				</div>
				<button type="submit" class="btn btn-default">查找</button>
				<%--<a  href="javascript:;"  onclick="submit" class="btn btn-default"> 查找</a>--%>
