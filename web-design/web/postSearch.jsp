...
<div id="main">
    ...
    <div id="toolbar">
        <%
            String pnumFromPost=request.getParameter("pnumFromPost");
            if(pnumFromPost==null){
                pnumFromPost="";
            }
        %>
        <input class="form-control2" style="width:100px" id="pid" name="pid" value="<%=pnumFromPost%>" placeholder="岗位编号">
        <input class="form-control2" style="width:100px" id="pname" name="pname"  placeholder="岗位名称">
        ...
        $('#table').bootstrapTable('refresh',
            {
                ...
                url:'GetStaffByPostNumServlet?pid='+pnum
